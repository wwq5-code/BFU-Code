...
def FL_unlearn_train(net_glob, net_temp, args, dataset_train, dataset_test, dict_users, idxs_local_dict, erased_perm, train_type="train"):
    net_glob.train()
    w_glob = net_glob.state_dict()
    acc_test = []
...
def clean_FL(args):
    ...
    unlearn_nips = FL_unlearn_train(unlearn_nips, net_glob, args, dataset_train, dataset_test, dict_users, idxs_local_dict, erased_perm, train_type='unlearn')
    ...
    unlearn_self = FL_unlearn_train(unlearn_self, net_glob, args, dataset_train, dataset_test, dict_users, idxs_local_dict, erased_perm, train_type='self-sharing')
    ...
    retrian_net2, KL_fr, KL_self_r = FL_retrain(retrian_net2, net_glob, unlearn_self, args, dataset_train, dataset_test, dict_users, idxs_local_dict, retrain_epoch= args.epochs, train_type='retrain')
